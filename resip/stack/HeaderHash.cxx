...
#line 114 "HeaderHash.gperf"
      {"x-offline-seconds", Headers::XOfflineSecond},// 113
#line 115 "HeaderHash.gperf"
      {"x-message-composing-info", Headers::XMessageComposingInfo},// 114
#line 116 "HeaderHash.gperf"
      {"x-push-os", Headers::XPushOS},// 115
#line 117 "HeaderHash.gperf"
      {"x-push-deviceid", Headers::XPushDeviceID},// 116
#line 118 "HeaderHash.gperf"
      {"x-push-token", Headers::XPushToken},// 117
#line 119 "HeaderHash.gperf"
      {"x-messagetype", Headers::XMessageType},// 118
#line 120 "HeaderHash.gperf"
      {"x-message-uuid", Headers::XMessageUUID}// 119
  ...
  __android_log_print(ANDROID_LOG_DEBUG, "DEBUG PARSE HEADER", "PRINT PARSE HEADER AAA:2 2length=%d, 4String=%s", len, str);
      ...
      if (key <= MAX_HASH_VALUE && key >= 0)
        {
          ...
          __android_log_print(ANDROID_LOG_DEBUG, "DEBUG PARSE HEADER", "PRINT PARSE HEADER AAA:1 index=%d, 2length=%d, 3key=%d, 4String=%s", index, len, key, str);

          if (index >= 0)
            {
              register const char *s = wordlist[index].name;
              __android_log_print(ANDROID_LOG_DEBUG, "DEBUG PARSE HEADER", "PRINT PARSE HEADER : index=%d, String=%s, length=%d, key=%d, name=%s", index, str, len, key, s);
